...
----------------------------------------*/
int iEdgeDet(int* piStatusOld, int* piStatusNew, int iEdgeType)	//function for edge detection (iEdgeType -> 0 = NEG / 1 = POS)
{	
...
----------------------------------------*/
void vSendPort(int iStatusArray[8])					//function for sending full port from a pointer array
{
	int iCounter;									//create variable iCounter
...
----------------------------------------*/
void vClearArray(int iStatusArray[8])				//function for clearing an array
{ 
	int iCounter;             						//create variable iCounter          
